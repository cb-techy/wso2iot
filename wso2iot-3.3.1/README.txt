...
==============================================================
Welcome to the WSO2 IoT Server (IoTS) 3.3.1 release.
...
https://docs.wso2.com/display/IoTS331/About+this+Release
...
==================================
1. Extract  wso2iot-3.3.1.zip and go to the extracted directory/bin.
...
=============================================
 ...
 - bin
    ...
    - release-notes.html
	  Release information for WSO2 IoT 3.3.1
